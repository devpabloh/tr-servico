...
const defaultFormData = {
  ...
  sim_texto_registro_preco_corporativo: "1.1 Formação de registro de preços corporativo para contratação eventual de prestação de serviços de (TIPO DE SERVIÇO VAI VIR DO HOME), visando atender as necessidades dos órgãos da Administração Direta, Fundos Especiais, Autarquias e Fundações Públicas integrantes do Poder Executivo do Estado de Pernambuco, conforme as condições, especificações, quantidades e exigências contidas {eEstudosTecnicosPreliminares} neste Termo de Referência.",
  sim_texto_registro_preco_corporativo_e_havera_reducao_escopo: "1.1 Formação de registro de preços corporativo para contratação eventual de prestação de serviços de (TIPO DE SERVIÇO VAI VIR DO HOME), visando atender as necessidades dos {quaisOrgaosOuEntidades}, conforme as condições, especificações, quantidades e exigências contidas no {eEstudosTecnicosPreliminares} neste Termo de Referência.",
  ...
  texto_nao_p3_complemento: "2.5.3. E ainda não está presente o grande vulto da contratação, pois {nao_havendo_grande_vulto_da_contratacao}.",
  texto_nao_p3_mais_complemento: "2.5.3. Além disso, no caso vertente, não se faz presente a premissa da complexidade do objeto, uma vez que {nao_havendo_complexidade_objeto}. E ainda não está presente o grande vulto da contratação, pois {nao_havendo_grande_vulto_da_contratacao}.",
  ...
  texto_amostra_prazo_p1: "5.2.4.2 O prazo definido para sua apresentação, conforme definido, é reputado razoável para as providências de realização da prova de conceito.",
  ...
  comprovacaoAtendimentoPercentualPorExtenso: "",
