...
import type { 
  ...
  const defaultFormData = {
    ...
    texto_nao_justificativa_quantitativo_textoDois: "2.2.2 Os quantitativos previstos no presente Termo de Referência foram definidos no documento {osQuantitativosPrecistoDefinidosNoDocumento}.",
    // 2.3.1
    ...
    texto_amostra_prazo_p1: "5.2.4.2 O prazo definido para sua apresentação, conforme definido no subitem abaixo, é reputado razoável para as providências de realização da prova de conceito pelo licitante OU adjudicatária OU contratada OU detentora da ata de registro de preços.", 
    ...
    prova_conceito_redacao_para_todos_os_casos_texto_quinto:"5.2.4.8 Para fins de comprovação de atendimento, o licitante deve demonstrar, pelo menos, comprovacaoAtendimentoPercentual% ({comprovacaoAtendimentoPercentual}) por cento) dos itens constantes no subitem deste termo de referência.",
    ...
    prova_conceito_redacao_para_todos_os_casos_texto_onze:"5.2.4.14 Depois de vencido o prazo de apresentação da prova de conceito, nos termos estabelecidos neste Termo de Referência e seu(s) Anexo(s), não será permitida nova apresentação por parte do licitante OU adjudicatária OU contratada OU detentora da ata de registro de preços.",
    prova_conceito_redacao_para_todos_os_casos_texto_doze:"5.2.4.15 Os custos pela realização da Prova de Conceito {aProvaDeConceito} de interesse da Administraçãoserão de responsabilidade exclusiva do licitante OU adjudicatária OU contratada OU detentora da ata de registro de preços.",
