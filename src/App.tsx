...
import type { 
  ...
  const defaultFormData = {
    ...
    texto_adesao_sim_letra_b: "b) A soma de todas as adesões à Ata de Registro de Preços, não poderá exceder o {limiteAdesaoTotal} % ({limiteAdesaoTotalExtenso}) do quantitativo registrado.",
