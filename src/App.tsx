...
import type { 
  ...
  const defaultFormData = {
    ...
    texto_amostra_prazo_p1: "5.2.4.2 O prazo definido para sua apresentação, conforme definido, é reputado razoável para as providências de realização da prova de conceito pelo {deInteresseDas}.", 
