...
import type { 
  ...
  const defaultFormData = {
    ...
    texto_dois_amostra_fase_julgamento: "5.2.4.4O licitante será desclassificado automaticamente do certame se descumprir os prazos e horários, desde que o descumprimento tenha sido ocasionado por situação de sua responsabilidade.",
